...
git clone git@git.yonyou.com:bd_ae/AA_Cloud_Web.git
...
# install the third-party lib with bower
cd src/assets
bower install

# start the server in directory AA_Cloud_Web
cd ../..
npm start
